...
public class pose : MonoBehaviour
{
    ...
    public GameObject Center,neck,rightElbow, leftElbow, rightShoulder, rightShoulder2, leftShoulder, leftShoulder2, rightHip, leftHip, rightKnee, leftKnee, rightAnkle, leftAnkle, leftHand, rightHand, leftFinger, rightFinger, leftFingerN, rightFingerN, leftToe, rightToe, leftToeN, rightToeN;
    ...
    void Update()
    {
        ...
        using (StreamReader r = new StreamReader(fs))
        {
           ...
           // setBone(16, leftHand, bones);
            ...
            //neck.transform.position = new Vector3((float)(d / 2), (float)(e / 2), (float)(f / 2));
