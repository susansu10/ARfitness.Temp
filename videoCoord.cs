...
public class Body2
{
    public Bone2[] bone = new Bone2[33];
}
public class videoCoord : MonoBehaviour
{
    string path = @"E:\code\pythonProject\project\cvZoneVideoCap\videoCapFile.txt";
    ...
    //public Vector3 k;
    public void setBone(int bone_id, GameObject bone_arg, List<Bone2> body_arg)
    {
    ...
    void Update()
    {
        ...
        using (StreamReader r = new StreamReader(fs))
        {
            ...
            var bones = JsonConvert.DeserializeObject<List<Bone2>>(json);
